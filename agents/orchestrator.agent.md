...
**Policy:** `.github/AGENTS.md` — enforce phase gates; require handoff template from every specialist; reject if DoD not met.
...
0. If any questions or clarifications are needed at any phase, prompt the user for answers before proceeding.
