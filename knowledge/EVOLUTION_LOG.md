...
| 2026-05-08 | all    | Agent definitions contained editor-specific tool names (VS Code Copilot tools only), blocking IntelliJ engineers from using the same agent definitions | Introduce capability abstraction layer: agent definitions reference abstract capabilities; tool-to-capability mapping in .github/capabilities/tool-mapping.md; IDE-specific guides in .github/integrations/ | orchestrator | orchestrator     | yes      |
